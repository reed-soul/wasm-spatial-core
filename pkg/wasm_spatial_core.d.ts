...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3660: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3666: (a: number, b: number, c: number, d: number) => void;
