...
/// Maximum number of values allowed when reading a tag entry's vector.
/// Prevents hostile inputs from triggering huge allocations.
const MAX_TAG_VALUES: usize = 1_000_000;
